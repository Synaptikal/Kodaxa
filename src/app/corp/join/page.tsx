  ...
  return (
    <div className="flex flex-col min-h-dvh bg-sr-bg text-slate-200">
      ...
      <main className="flex-1 max-w-2xl mx-auto w-full px-4 py-10 space-y-8">
        ...
        {/* What to expect */}
        <div className="border border-sr-border bg-sr-surface/40 p-4 space-y-2">
          <p className="text-[9px] font-mono uppercase tracking-widest text-slate-600">What to Expect</p>
